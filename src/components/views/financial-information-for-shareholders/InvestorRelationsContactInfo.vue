<template>
  ...
  <!-- <div class=" container   " >
    <div class="investor_relation sectionTitle">
      <h2 class="h2Responsive ">{{investorContactDetail.title}}</h2>
      <p>Phone: {{investorContactDetail.phone}}</p>
      <p>Email: {{investorContactDetail.email}}</p> <br>
      <span style="font-size: 14px;" v-html="investorContactDetail.description"></span>
    </div>
  </div> -->
  <div class="container">
...
<!--                      <li><strong>Email:</strong> {{investorContactDetail.email}},</li>-->
                      <li><span style="font-size: 14px;" v-html="investorContactDetail.description"></span></li>
                    </ul>
...
<script>
    ...
    export default {
      name: "InvestorRelationsContactInfo",
      data() {
        return {
          active_tab: true,
