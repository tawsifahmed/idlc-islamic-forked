                    ...
                    <div class=" reason col-md-4">
                            ...
                            <div class="inputBox invest success error" >
                                <div class="feilds">
                                    ...
                                    <div class="title">
                                        <label class="title2">
                                            <span class="amtValueBlock">Deposit Amount (BDT)</span>
                                        </label>
                                        <label class="errorText">Please enter an amount</label>
                                    </div>

                                    <input type="text" id="PrincipleAmt" name="principle" numbers-only="" required="" limit-to-max="" maxlength="11" tabindex="1" limit-to-min="" min="1" max="20000000"  placeholder="Please input the Deposit amount" class="wantToMake formatNumber ng-valid-maxlength ng-dirty ng-valid-parse ng-empty ng-invalid ng-invalid-required ng-touched range-slider__value">
                    ...
                    <div class=" reason col-md-4">
                        ...
                        <div class="inputBox invest success error" >
                            <div class="feilds">
                                ...
                                <div class="title">
                                    <label class="title2">
                                        <span class="amtValueBlock">Deposit Tenure ({{tenureUnit}})</span>
                                    </label>
                                    <label class="errorText">Please enter an amount</label>
                                </div>

                                <input type="text" id="loanTenure" name="principle" numbers-only="" required="" limit-to-max="" maxlength="11" tabindex="1" limit-to-min="" min="1" max="20" placeholder="Please input the Deposit Tenure" class="wantToMake formatNumber ng-valid-maxlength ng-dirty ng-valid-parse ng-empty ng-invalid ng-invalid-required ng-touched">
                    ...
                    <div class="col-md-6 align-self-center">
                        ...
                        <div class="row justify-content-md-space-between">
                            ...
                            <div class="col-md-6 text-left">
                                <!-- <button class=" tabcontent2Button" @click='detaiShow = !detaiShow'>Deposit Details</button> -->
                            </div>
                        </div>
                    </div>
