      ...
      <div class="container-lg">
        <div class="tab">
          <button class="tablinks active" @click="whyChoosetab( 'whychose', $event)" id="defaultOpen"><img
            src="~@/assets/img/productWhyChoose/Why-choose-IDLC.png" alt="">Why Choose IDLC Islamic
          </button>
        ...
        <div id="whychose" class="tabcontent" style="display:block;">
          ...
          <div class="whyChoosebody">
            ...
            <div class="reason">
              <img v-lazy="lowerTabContents.why_choose_five_image" alt="">
              <h5>{{ lowerTabContents.why_choose_five_title }}</h5>
              <div class="line"></div>
              <p>{{ lowerTabContents.why_choose_five_subtitle}}</p>
            </div>
