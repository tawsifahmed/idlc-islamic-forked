      ...
      <div class="col-md-10 offset-md-1">
        <form  @submit.prevent="onSubmit" method="post" class=custom_form>
          <div class="mb-3">
            ...
            <input   v-model="form.name" type="text" name="name" class="form-control" id="name" placeholder="Type Your Name"  required="true">
          </div>
          <div class="mb-3">
            <label for="email" class="form-label">Your Email (আপনার ইমেইল)</label>
            <input v-model="form.email"  type="email" class="form-control" id="email" placeholder="Type Your Email"  required="true">
          </div>
          <div class="mb-3">
            <label for="address" class="form-label">Your Address (আপনার ঠিকানা)</label>
            <input v-model="form.address" type="text" class="form-control" id="address" placeholder="Type Your Address"  required="true">
          </div>
          <div class="mb-3">
            <label  class="form-label">Your District (জেলা)</label>
            <select  v-model="form.district" class="form-control decorated" name="district"  required="true"  >
          ...
          <div class="mb-3">
            ...
            <input v-model="form.phone" type="text" class="form-control" id="phone" placeholder="Type Your Phone">
          </div>
          <p class="term-condition">Our Terms and Conditions template will get you started with creating your own custom Terms and Conditions agreement. This Terms and Conditions template is free to download and use for your website or mobile app.</p>
          ...
          <div class="col-md-12">
            ...
            <div v-if="form.errors.length">
              <b-alert
                ...
                dismissible
                fade
                variant="warning" v-for="error in form.errors"
                :key="error"
              >
