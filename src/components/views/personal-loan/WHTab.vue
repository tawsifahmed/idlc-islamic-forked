      ...
      <div class="container-lg">
        <div class="tab">
          <button class="tablinks active" @click="whyChoosetab( 'whychose', $event)" id="defaultOpen"><img
            src="~@/assets/img/productWhyChoose/Why-choose-IDLC.png" alt="">Why Choose
          </button>
        ...
        <div id="contactUs" class="tabcontent">
          <div class="whychoseTabContent">
            ...
            <div class="sort_detail">
              ...
              <router-link :to="{ name: 'ContactUs', params: { branchId : ''}}" class="tabcontent1ButtonBase"> View More </router-link>
            </div>
          </div>
        </div>
