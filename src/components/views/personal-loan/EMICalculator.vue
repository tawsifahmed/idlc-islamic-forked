                    ...
                    <div class=" reason col-md-4">
                            ...
                            <div class="inputBox invest success error" >
                                <div class="feilds">
                                    ...
                                    <input type="text" id="PrincipleAmt" name="principle" numbers-only="" required="" limit-to-max="" maxlength="11" tabindex="1" limit-to-min="" min="1" max="20000000"  placeholder="Please input the Loan amount" class="wantToMake formatNumber ng-valid-maxlength ng-dirty ng-valid-parse ng-empty ng-invalid ng-invalid-required ng-touched range-slider__value" v-model.number="loanAmount">
                        ...
                        <div class="employeeDetWrap">
                            <div class="rangeSlider">
                                <div class="slidecontainer">
                                    <input  type="range" min="1" max="20000000" value="1000000" class="rangeValChange rangeslider"  v-model.number="loanAmount">
                                </div>
                    ...
                    <div class=" reason col-md-4">
                        ...
                        <div class="inputBox invest success error" >
                            <div class="feilds">
                                ...
                                <input type="number" id="loanTenure" name="principle" numbers-only="" required="" limit-to-max="" maxlength="11" tabindex="1" limit-to-min="" min="1" max="20" placeholder="Please input the Loan Tenure" class="wantToMake formatNumber ng-valid-maxlength ng-dirty ng-valid-parse ng-empty ng-invalid ng-invalid-required ng-touched" v-model.number="loanTuner">
                        ...
                        <div class="employeeDetWrap">
                            <div class="rangeSlider">
                                <div class="slidecontainer">
                                    <input  type="range" min="1" max="20" value="7" class="rangeValChange rangeslider"    v-model="loanTuner">
                                </div>
                                <div class="row minmaxHide">
                    ...
                    <div class=" reason col-md-4">
                        ...
                        <div class="inputBox invest success error" >
                            <div class="feilds">
                                ...
                                <input   type="text" id="RateOfInterest" name="principle" numbers-only="" required="" limit-to-max="" maxlength="11" tabindex="1" limit-to-min="" min="1" max="20" placeholder="Please input the Rate of Interest" class="wantToMake formatNumber ng-valid-maxlength ng-dirty ng-valid-parse ng-empty ng-invalid ng-invalid-required ng-touched" v-model="rateOfInterest">
                        ...
                        <div class="employeeDetWrap">
                            <div class="rangeSlider">
                                <div class="slidecontainer">
                                    <input type="range" min="1" max="20" value="11" class="rangeValChange rangeslider"  v-model="rateOfInterest">
                                </div>
                                <div class="row minmaxHide">
                        ...
                        <div class="editableFields">
                            <ul class="list-inline">
                                <li>
                                    ...
                                    <br>
                                    <span class="editableInput totInvmnt"><span id="">{{ReplaceNumberWithCommas(emi.toFixed(2))}}</span> BDT</span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-6 align-self-center">
                        ...
                        <div class="row justify-content-md-space-between">
                            <div class="col-md-6 text-right">
                                <router-link :to="{ name: 'ApplyForLoan', params: { applyFor : 'personalLoan'}}"  target="_blank" class="tabcontent2Button">Apply Now</router-link>
                            </div>
...
<!--                            </div>-->
                    ...
                    <div class=" col-md-12 " >
                        <transition name="slide-fade" mode="out-in">
                            <canvas v-show="detaiShow" id="myChart" width="100%" height="350" ></canvas>
                        </transition>
                    </div>
