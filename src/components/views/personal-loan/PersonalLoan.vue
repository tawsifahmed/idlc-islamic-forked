...
<script>
  ...
  export default {
    metaInfo: {
      title: 'Personal Loan - Personal Loans with Monthly Payments Online | IDLC',
      meta: [
        { name: 'description', content: 'Get a personal loan at flexible interest rates, to fulfill your desires, or use calculators to plan' },
        { name: 'keywords', content: 'Personal Loan, Online Loan, loan calculator, personal finance, monthly payment, emi, term loan, interest rate' },
      ]
    },
    name: 'Personal-loan',
    data () {
    ...
    components: {
      ...
      AppKeyFeature: () => import('./KeyFeature'),
