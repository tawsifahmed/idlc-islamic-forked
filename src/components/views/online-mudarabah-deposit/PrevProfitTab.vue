<template>
  <section class="container">
    ...
    <b-card class="product-card">
      <a v-b-toggle="'annualReportcollapse' + index" block class="d-flex cursor_pointer">
      ...
      <b-collapse v-bind:id="'annualReportcollapse' + index">
        <b-card class="question-card">
          <b-card v-if="depoPrevProfits.length <= 0" class="question-card loading">
          ...
          <div v-else class="row">
            <div class="latest_news slider multiple-items col-md-12">
              <div class="row">
                ...
                <div v-for="file in depoPrevProfits" :key="file.id" class="col-lg-3 col-ms-6 col-12">
                  <div class="card-single-pdf">
                    ...
                    <div class="report-name">
                      <h6 class="file-name" :title="file.title">{{ file.title.length >= 20 ?  file.title.substring(0, 20) + '...' : file.title }}</h6>
                      <p class="file-brief" v-b-tooltip.hover.bottom="file.tab_name">{{file.tab_name.length >= 35 ? file.tab_name.substring(0, 35) + '...' : file.tab_name}}</p>
                    </div>
                    <div class="download-report-btn">
                      <a :href="file.file" target="_blank" style="color: white !important;"
                        download>View</a>
