      ...
      >
        ...
        <div class="container-lg">
          <div class="tab">
            ...
            <button
              class="tablinks1 "
              @click="openTab('eligibility' + itemData.id, $event)"
            >
              Eligibility
            </button>
            <button
              class="tablinks1 "
              @click="openTab('howCanIUse' + itemData.id, $event)"
            >
              How I can use this loan
            </button>
            <button
              class="tablinks1 "
          ...
          >
            ...
            <!--            <router-link :to="{ name: 'ApplyForLoan', params: { applyFor : 'SmeLoan'}}"  target="_blank" class="tabcontent1Button">Apply Now</router-link>-->
          </div>
