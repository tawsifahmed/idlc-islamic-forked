...
<div class="container">
  ...
  <!-- <div class="row filterOptions commonSpace">

    <div class="col-sm-12 col-md-4 col-lg-4 mpadding">

      <v-select label="name"
                placeholder="Filter By Department"
                :options="departments"
                @input="searchByDepartment"
                :reduce="name => name.id"
    ...
    <div class="col-sm-12 col-md-4 col-lg-4 mpadding">
      <input type="text" class="form-control search-pdf " placeholder='Search' v-model="search" @input="searchByDepartment">
    </div>
  </div> -->
        ...
        <div class="col-md-8 col-sm-12">
          ...
          <div class="row">
              <ul class="list-group list-group-horizontal">
                <li class="list-group-item"> <i class="fa fa-h-square" aria-hidden="true"></i> IDLC</li>
                <li class="list-group-item"> <i class="fa fa-clipboard" aria-hidden="true"></i> {{ item.department.name}}</li>
              </ul>
          </div>
        </div>
        <div class="col-md-4 col-sm-12 pull-right text-right  ">
          <b-button v-b-toggle="'id_'+item.id" class="m-1 tabcontent2Button expand text-right">  <i class="fa fa-plus" aria-hidden="true"></i></b-button>
          <a :href="item.apply_link" target="_blank"> <button class="tabcontent2Button text-right ">Apply</button> </a>

<!--          <button class="tabcontent2Button text-right shareButton"><i class="fa fa-share-alt" aria-hidden="true"></i>
            Share</button>-->
        </div>
    ...
    <b-collapse class="row" v-b-toggle="'collapse-2'">
    <div >

    </div>
    </b-collapse>

    <b-collapse :id="'id_'+item.id">
      <b-card>
  ...
  <div class="row mb-3 text-center " style="margin-left: auto; margin-right: auto; display: block;" >
    <div style="display: inline-block; padding: 20px 30px; margin-top: 20px; background-color: #fff; box-shadow: 0 0 5px rgba(0, 0, 0, .2); ">
      <a href="/applied-career" class=" upload-btn-wrapper tabcontent2Button  text-center"> <i class="fas fa-upload"></i> Upload CV </a>
      <a href="/applied-career" class=" upload-btn-wrapper tabcontent2Button  text-center"> <i class="fab fa-linkedin"></i> IDLC at LinkedIn </a>
    </div>
  </div>
</div>
