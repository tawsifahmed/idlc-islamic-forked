    ...
    <div class="container">
      ...
      <div class="philosophy">
        ...
        <div class="our_values">
          <ul style="    ">
            <li><i class="far fa-check-circle"></i>Integrity</li>
            <li><i class="far fa-check-circle"></i>Customer Focus</li>
            <li><i class="far fa-check-circle"></i>Equal Opportunity</li>
            <li><i class="far fa-check-circle"></i>Trust and Respect</li>
            <li><i class="far fa-check-circle"></i>Passion</li>
            <li><i class="far fa-check-circle"></i>Simplicity</li>
            <li><i class="far fa-check-circle"></i>Eco-Friendly</li>
          </ul>
        </div>
      </div>
    </div>
