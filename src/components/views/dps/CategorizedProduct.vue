              ...
              <form class="categoryForm">
                <div class="form-group row justify-content-center">
                  <label class="col-sm-12 col-form-label category_label"
                    >I want to take a loan for</label
                  >
...
export default {
  ...
  updated() {
    ...
    for (i = 0; i < l; i++) {
      ...
      a.setAttribute("class", "select-selected-black");
    ...
    function closeAllSelect(elmnt) {
      ...
      y = document.getElementsByClassName("select-selected-black");
      xl = x.length;
      yl = y.length;
      for (i = 0; i < yl; i++) {
        if (elmnt == y[i]) {
...
@media screen and (max-width: 600px) {
  .productFeatures .tab .tablinks1:first-child,
