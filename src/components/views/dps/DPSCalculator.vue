        ...
        <div class="container-lg">
            <div class="calculatorBody ">
                ...
                <div class="header sectionTitle">
                    <h2 class="h2Responsive">DPS CALCULATOR</h2>
                </div>
                </div>
                <div class="row">
                    <div class=" reason col-md-4">
                            <div class="inputBox invest success error" >
                                <div class="feilds">
                                    ...
                                    <div class="title">
                                        <label class="title2">
                                            <span class="amtValueBlock">DPS Amount (BDT)</span>
                                        </label>
                                        <label class="errorText">Please enter an amount</label>
                                    </div>

                                    <input type="text"
                                           v-model="choosableAmount"
                                           id="PrincipleAmt"
                                           name="principle"
                                           numbers-only=""
                                           required=""
                    ...
                    <div class=" reason col-md-4">
                        ...
                        <div class="inputBox invest success error" >
                            <div class="feilds">
                                ...
                                <div class="title">
                                    <label class="title2">
                                        <span class="amtValueBlock">DPS Tenure ({{tenureUnit}})</span>
                                    </label>
                                    <label class="errorText">Please enter an amount</label>
                                </div>

                                <input type="text"
                                       v-model="choosableDuration"
                                       id="loanTenure"
                                       name="principle"
                                       numbers-only=""
                                       required=""
                                       ...
                                       min="1"
                                       max="20"
                                       placeholder="Please input the Loan Tenure"
                    ...
                    <div class=" reason col-md-4">
                        ...
                        <div class="inputBox invest success error" >
                            <div class="feilds">
                                ...
                                <input   type="text"
                                         v-model="choosableRateOfInterest"
                                         id="RateOfInterest"
                                         name="principle"
                                         numbers-only=""
                                         required=""
                        ...
                        <div class="editableFields">
                            <ul class="list-inline">
                                <li>
                                    ...
                                    <br>
                                    <span class="editableInput totInvmnt"><span id="emaiAmount">{{ total }}</span> BDT</span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-6 align-self-center">
                        ...
                        <div class="row justify-content-md-space-between">
                            <div class="col-md-6 text-right">
                                <router-link to="/apply-for-deposit" class="tabcontent2Button">Apply Now</router-link>
                            </div>
...
export default {
    data() {
        return {
          ...
          detaiShow: false,
          choosableAmount:2000000,
          choosableDuration: 7,
          choosableRateOfInterest: 11,
  ...
  computed:{
    total() {
      let tenureInMonths = this.choosableDuration*12;
      let covertedRoi = this.choosableRateOfInterest/100;
      let finalRoi = (1+ covertedRoi/12);
      let finalTenure = ((finalRoi ** (tenureInMonths))-1)/ (covertedRoi/12);
      let calculatedTotal = (finalRoi * this.choosableAmount * finalTenure);
       this.payAbleAmountPerMonth = calculatedTotal;
      return this.ReplaceNumberWithCommas(calculatedTotal.toFixed(0));
    }
