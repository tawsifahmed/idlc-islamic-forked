<template>
  <section>
    ...
    <div v-if="productData.length > 0" class="category">
      <!-- <div class="top_curve"></div> -->
      <div class=" categoryBg">
        <div class="container-lg">
          <div class="categoryBody">
            <!-- <div class="header sectionTitle">
              <h2 class="h2Responsive ">UNEP FI ACTIVITIES</h2>
            </div> -->
            <div class="container">
    ...
    <div v-if="productData.length > 0" class="productFeatures">
      <div
      ...
      >
        ...
        <div class="container-lg">
          ...
          >
            <span v-html="itemData.description"></span><br />
            <!--            <router-link to="/get-in-touch-with-us"  target="_blank" class="tabcontent1Button">Get in Touch</router-link>-->
          </div>
        </div>
      </div>
    </div>
...
.mcategory .reason a h6 {
  color: #fff;
}

.mcategory .reason a img {
  transition: all 0.3s;
  height: 80px;
  width: 80px;
