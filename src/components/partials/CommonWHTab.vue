  ...
  <div class="productWhychoose">
    ...
    <div class="productWhychooseImgBg">
      <div class="container-lg">
        <div class="tab">
          <button class="tablinks active" @click="whyChoosetab( 'whychose', $event)" id="defaultOpen">
            <img src="~@/assets/img/productWhyChoose/Why-choose-IDLC.png" alt="">Why Choose IDLC
          </button>
          <button class="tablinks" @click="whyChoosetab( 'faq', $event)">
            <img src="~@/assets/img/productWhyChoose/FAQ.png" alt="">FAQ
          </button>
          <button class="tablinks" @click="whyChoosetab( 'contactUs', $event)">
            <img src="~@/assets/img/productWhyChoose/Contact-us.png" alt="">Contact Us
          </button>
          <button class="tablinks" @click="whyChoosetab( 'downloadBrochures', $event)">
            <img src="~@/assets/img/productWhyChoose/Download-Brochures.png" alt="">Download Brochures
          </button>
        </div>
        ...
        <div id="downloadBrochures" class="tabcontent">
          <div class="whychoseTabContent">
            ...
            <div class="sort_detail">
              ...
              <a v-if="lowerTabContents.brochure_download" :href="lowerTabContents.brochure_download" class="tabcontent1ButtonBase" target="_blank" download >Download Now</a>
            </div>
          </div>
        </div>
      </div>
...
<style scoped>
  ...
  /* .productWhychoose #whychose .tabcontent {
    display: block;
  } */
