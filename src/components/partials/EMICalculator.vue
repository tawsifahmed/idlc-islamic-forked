                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="loanAmountInput">
                                                      ...
                                                      <label for="loanAmount">{{ ReplaceNumberWithCommas(loanAmount) }}</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <input min="100000" max="20000000" step="500" type="range" id="" class="rangeValChange rangeslider" v-model.number="loanAmount">
                                                </div>
                                                <div class="col-md-6"><span class="minMaxValue">100,000 BDT</span></div>
                        ...
                        <div class="graph">
                          <div class="graphTitle text-center pt-3 pb-0">
                            ...
                            <div class="graphDetails">
                                ...
                                <div class="detailSingle">
                                    <div class="name">Total Payable Amount</div>
...
.calculatorForm .loanAmountInput label {
    margin: 0;
    position: absolute;
    top: 3px;
    left: 5px;
...
.calculatorForm .loanAmountInput input:focus ~ label {
    display: none;
}
