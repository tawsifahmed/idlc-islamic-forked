    ...
    >
      ...
      <ul class="sideNavUl" v-show="isSearchResult">
        ...
        <b-card no-body class="mb-1 mFootter firstCard sidenavLinks">
          <b-card-header class="bg-white" role="tab" style="width: 95%; margin: 0 auto; border-bottom: 1px solid #ccc;">
            <b-button class="position-relative pr-4" block v-b-toggle.accordion-1 variant="white" style="color: #00a6b4 !important;"
              >Our Products <span class="position-absolute pl-1"><svg xmlns="http://www.w3.org/2000/svg" width="20" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <b-card-body style="padding: 0px;">
              <ul class="list-unstyled f_list">
                <li style="background: #fbfbfb;">
                  <router-link to="/islamic-deposits" class="py-3" style="color: #00a6b4 !important;">Islamic Deposit Products</router-link>
                </li>
                <li style="background: #fbfbfb;">
        ...
        <b-card no-body class="mb-1 mFootter firstCard sidenavLinks">
          <b-card-header class="bg-white" role="tab" style="width: 95%; margin: 0 auto; border-bottom: 1px solid #ccc;">
            <b-button class="position-relative pr-4" block v-b-toggle.accordion-2 variant="white" style="color: #00a6b4 !important;"
              >Content Repository <span class="position-absolute pl-1"><svg xmlns="http://www.w3.org/2000/svg" width="20" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
              </svg>
              </span> </b-button>
          </b-card-header>
        ...
        <b-card no-body class="mb-1 mFootter firstCard sidenavLinks">
          <b-card-header class="bg-white" role="tab" style="width: 95%; margin: 0 auto; border-bottom: 1px solid #ccc;">
            <b-button class="position-relative pr-3" block v-b-toggle.accordion-3 variant="white" style="color: #00a6b4 !important;"
              >About Us <span class="position-absolute pl-1"><svg xmlns="http://www.w3.org/2000/svg" width="20" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
              </svg>
              </span> </b-button>
          </b-card-header>
